...
#include "traj_utils/msg/detail/data_disp__type_support.h"
...
static const _DataDisp_type_support_symbol_names_t _DataDisp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traj_utils, msg, DataDisp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traj_utils, msg, DataDisp)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, traj_utils, msg, DataDisp)() {
  return &::traj_utils::msg::rosidl_typesupport_c::DataDisp_message_type_support_handle;
}
