...
#include "traj_utils/msg/detail/bspline__type_support.h"
...
static const _Bspline_type_support_symbol_names_t _Bspline_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traj_utils, msg, Bspline)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traj_utils, msg, Bspline)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, traj_utils, msg, Bspline)() {
  return &::traj_utils::msg::rosidl_typesupport_c::Bspline_message_type_support_handle;
}
