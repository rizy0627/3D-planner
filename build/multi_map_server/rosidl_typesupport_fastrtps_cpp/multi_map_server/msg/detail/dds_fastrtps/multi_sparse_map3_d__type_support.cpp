...
#include "multi_map_server/msg/detail/multi_sparse_map3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const multi_map_server::msg::SparseMap3D &,
  ...
  size_t current_alignment)
{
  ...
  // Member: maps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        multi_map_server::msg::typesupport_fastrtps_cpp::max_serialized_size_SparseMap3D(
  ...
  if (is_plain) {
    ...
    using DataType = multi_map_server::msg::MultiSparseMap3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_server::msg::MultiSparseMap3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_map_server::msg::MultiSparseMap3D *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MultiSparseMap3D__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const multi_map_server::msg::MultiSparseMap3D *>(
...
static size_t _MultiSparseMap3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MultiSparseMap3D(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MultiSparseMap3D__callbacks = {
...
static rosidl_message_type_support_t _MultiSparseMap3D__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MultiSparseMap3D__callbacks,
...
{
  return &multi_map_server::msg::typesupport_fastrtps_cpp::_MultiSparseMap3D__handle;
}
