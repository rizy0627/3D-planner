...
static const _MultiSparseMap3D_type_support_symbol_names_t _MultiSparseMap3D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_server, msg, MultiSparseMap3D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multi_map_server, msg, MultiSparseMap3D)),
  }
};
...
{
  return &::multi_map_server::msg::rosidl_typesupport_cpp::MultiSparseMap3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, multi_map_server, msg, MultiSparseMap3D)() {
  return get_message_type_support_handle<multi_map_server::msg::MultiSparseMap3D>();
}
