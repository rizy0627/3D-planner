...
#define NODE_MAIN_LOGGER_NAME "so3_control_component_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libso3_control_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<SO3ControlComponent>";
